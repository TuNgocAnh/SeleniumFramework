...
> **BẮT BUỘC (MANDATORY SKILL):** Bạn PHẢI nạp và đọc kỹ nội dung của skill **`framework-architect`** (tại `.claude/skills/framework-architect/SKILL.md`) trước khi bắt đầu. Ngoài ra, tham khảo thêm skill **`qa-automation-engineer`** để nắm các quy tắc automation chung.
