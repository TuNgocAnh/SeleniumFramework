...
/**
 * Tìm element theo (role + accessible name). Hỗ trợ: - tag native tương ứng role (button, link,
 * input) - explicit attribute role="..." - accessible name match qua aria-label / value / text
 */
