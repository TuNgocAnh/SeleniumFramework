...
/**
 * Fuzzy match: tìm element có attribute (vd: class, id, data-test) CHỨA fragment. Sau khi tìm bằng
 * CSS, lọc tiếp chỉ giữ element visible. Đây là strategy yếu nhất — chỉ nên dùng làm last-resort
 * fallback.
 */
public class ByAttributeContainsStrategy implements HealStrategy {
  ...
  public Optional<WebElement> attempt(WebDriver driver) {
    ...
    List<WebElement> candidates =
        driver.findElements(By.cssSelector(css)).stream().filter(WebElement::isDisplayed).toList();
